...
public abstract class ChessComponent extends JComponent {
    ...
    public int mouseEventType = 0;
    //    private static final Dimension CHESSGRID_SIZE = new Dimension(1080 / 4 * 3 / 8, 1080 / 4 * 3 / 8);
    public static Color[] BACKGROUND_COLORS = {Color.WHITE, Color.BLACK};
    public static Color[] BACKGROUND_COLORS_PLUS = {Color.pink, Color.YELLOW};
    public static Color[] BACKGROUND_COLORS_ORIGIN = {Color.WHITE, Color.BLACK};
    ...
    public void swapLocation(ChessComponent another) {
        if(!Chessboard.currentColor.equals(chessColor)){return;}
        Music3 musicPlayer3 = new Music3();
        musicPlayer3.play();
    ...
    protected void paintComponent(Graphics g) {
        ...
        else {squareColor=Color.red;}
        g.setColor(squareColor);
        g.fillRect(0, 0, this.getWidth(), this.getHeight());

    }
public void setChessColor(ChessColor i){
        chessColor=i;
}
//    protected void paintComponentPlus(Graphics g) {
//        super.paintComponents(g);
//        System.out.printf("repaint chess [%d,%d]\n", chessboardPoint.getX(), chessboardPoint.getY());
//        Color squareColor = BACKGROUND_COLORS_PLUS[(chessboardPoint.getX() + chessboardPoint.getY()) % 2];
//        g.setColor(squareColor);
//        g.fillRect(0, 0, this.getWidth(), this.getHeight());
//
//    }
